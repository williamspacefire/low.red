...
export default class Short extends React.Component {
    ...
    shortUrl(e) {
        ...
        if (
            validUrl(this.state.url) &&
            !shortenerProviders.includes(urlParsed.host)
        ) {
            ...
            this.setState({
                shortData: {
                    ...
                    message: (
                        <>
                            This is already a <b>{urlParsed.host}</b> shortened
                            url.
                        </>
                    ),
                    code: 346,
            ...
            <>
                {this.state.shortData.error ? (
                    <Alert severity='error'>
                        {this.state.shortData.message}{' '}
                        <b>Code: {this.state.shortData.code}</b>
                    </Alert>
                ) : (
                    ''
                )}
